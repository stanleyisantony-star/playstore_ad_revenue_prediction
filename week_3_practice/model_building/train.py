...
Xtrain_path = "hf://datasets/HfStan/play-store-revenue-analysis/Xtrain.csv"
Xtest_path = "hf://datasets/HfStan/play-store-revenue-analysis/Xtest.csv"
ytrain_path = "hf://datasets/HfStan/play-store-revenue-analysis/ytrain.csv"
ytest_path = "hf://datasets/HfStan/play-store-revenue-analysis/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "HfStan/playstore_revenue_model"
    repo_type = "model"
